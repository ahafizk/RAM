...
def draw_framelength(filename,title):
    dir_name ='FullResults/stepsize/mean_std/'
    ...
    pp = PdfPages(filename+"step_size.pdf")
    ...
    step_sizes=[200,500,800,1000,1250,1500,1800]
    ax.set_xticklabels( (1,2.5,4,5,6.25,7.5,9) )
    # ax.set_xticklabels( (200, 500, 1000, 1500, 2000,2500,3000,3500,4000,4500) )
    ax.set_xlabel('Overlap(sec)')
...
if __name__=='__main__':
    ...
    title=activity+' Activity Accuracy by Step size and Fusion'
    # draw_entertainment()
    activities= ['Entertainment','Cooking','Cleaning','Bathroom']
    # draw_framelength(activity,title)
    for act in activities:
        title=act+' Activity Accuracy by Step size and Fusion'
